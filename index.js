...
const UUID = process.env.UUID || '023dcd05-f480-498a-9291-f0375d5c5064'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'api24-normal-useast1a.tiktokv.com.ikiweb.onlinee';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMTg1ODBiMzg2N2Q1NDA4MDdlN2Y3MDdlYWNjN2FjNzciLCJ0IjoiOWRkYWEwOWYtYmRlYS00MDRjLTkwZDgtNWUxMmZmYmIyMzZmIiwicyI6Ik5tWm1ZbUUwWlRVdE5tVTVNUzAwWkRBekxXSmhPVEl0T1RFME5XUXhZbVptT1dNeCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const CFIP = process.env.CFIP || 'api24-normal-useast1a.tiktokv.com';            // 节点优选域名或优选ip
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'sodod57';                        // 节点名称
